...
%\pl{drop the random variable from the subscript of $\mathbb E$ (e.g., $\mathbb E_{z^{(i)}})$; I don't think this is mathematically correct} %I dislike 

%\pl{give a high-level description of the proof strategy; would be good to have a proof sketch in the paper}
