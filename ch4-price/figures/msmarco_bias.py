...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', type=str, default="msmarco/msmarco_bias.json", help="")
    parser.add_argument('-o', '--output', type=str, default="msmarco_bias.pdf", help="An example trajectory for a task")
    parser.add_argument('-Ds', '--data-system', type=str, default="snet.single", help="An example trajectory for a task")
