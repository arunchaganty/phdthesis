...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', type=str, default="lqual/lqual_trajectories.json", help="")
    parser.add_argument('-ig', '--input-gold', type=str, default="lqual/lqual_trajectories_gold.json", help="")
    parser.add_argument('-o', '--output', type=str, default="lqual_trajectory.pdf", help="An example trajectory for a task")
    parser.add_argument('-Dp', '--data-prompt', type=str, default="hter", help="An example trajectory for a task")
    parser.add_argument('-Dm', '--data-metric', type=str, default="sim", help="An example trajectory for a task")
    parser.add_argument('-Ds', '--data-system', type=str, default="seq2seq", help="An example trajectory for a task")
