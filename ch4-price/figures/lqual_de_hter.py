...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', type=str, default="lqual/lqual_table.json", help="")
    parser.add_argument('-o', '--output', type=str, default="lqual_de_overall.pdf", help="An example trajectory for a task")
