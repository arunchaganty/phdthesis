...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output', type=str, default="msmarco_avgcorrect_de.pdf", help="An example trajectory for a task")
    parser.add_argument('-Dp', '--data-prompt', type=str, default="AvgCorrect", help="An example trajectory for a task")
