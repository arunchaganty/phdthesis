...
using the interfaces we've developed (\refsec{kbpo:evaluation}), it costs about \$15 to annotate a single document by non-expert crowdworkers, resulting in an estimated cost of at least \$1,350,000 for a reasonably large corpus of 90,000 documents \citep{dang2016kbp}.
...
We'll then instantiate the framework for KBP in \refsec{kbpo:application}.
...
%\footnote{Proofs for claims made in this section can be found in \refapp{sampling} of the supplementary material.}}
