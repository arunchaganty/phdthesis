\begin{figure}[!t]
  ...
  \begin{subfigure}{\columnwidth}
   ...
   \end{tabular}}
  \end{subfigure}
  \caption[Pooling bias in TAC-KBP 2015]{\label{fig:pooling-bias} Median pooling bias (difference between pooled and unpooled scores) on the top 40 systems of TAC KBP 2015 evaluation using the official and \anydoc{} scores.
