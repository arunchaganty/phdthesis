...
\reffig{game-tree}~(left) shows one possible outcome:
...
%Let us make our problem setting concrete with an example, depicted in \reffig{piano-roll}.
...
%
%We now describe our choice of models for prediction, human error and latencies and return to optimizing \refeqn{objective} in \sectionref{async}.
%
