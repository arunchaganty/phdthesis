...
it assumes that labels can only be observed \textit{after} classification,
...
%We aim to provide the analysis of on-the-job learning as a broader setting in this chapter.
