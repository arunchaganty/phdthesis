...
\begin{tabular}{l r r r}
  \toprule
    ...
    \bottomrule
\end{tabular}
\caption[Results on Face]{\label{tab:results-face} Results on the Face task comparing latencies, queries per token (Qs/tok)
and accuracy.}
\end{table}
...
\begin{table}[t]
  ...
  \caption[Results on the Sentiment task]{\label{tab:sentiment-results}Results on the Sentiment task comparing latency, queries per example and accuracy.
  }
\end{table}
