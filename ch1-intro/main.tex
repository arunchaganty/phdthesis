...
\reffig{intro:example-kbp} shows how the incomplete KBP reference data for Carrie Fisher, the late actress who played Princess Leia in the Star Wars movie franchise, is unable to judge when a system identifies her as an author (which is correct) or a princess (which is incorrect).
